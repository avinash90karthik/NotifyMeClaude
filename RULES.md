...
- **Mechanics:**
  ...
  - **Schema migration 2026-04-29:** `entry_price` / `stop_price` / `target_price` / `ko_level` columns made NULL-allowed for the clamped DB record path.
